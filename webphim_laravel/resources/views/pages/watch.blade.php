                   ...
                   <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                      <div class="halim-server">
                         <ul class="halim-list-eps">
                           @foreach ($movie->episodes as$key => $ep_movie)
                            <a href="{{ url('xem-phim/'.$movie->slug.'/tap-'.$ep_movie->episode) }}">
                              <li class="halim-episode">
                                 <span class="halim-btn halim-btn-2 {{$ep==$ep_movie->episode ? 'active' : ''}} halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="Xem phim {{$ep_movie->title}} - Tập {{$ep_movie->episode}} - {{$ep_movie->name_eng}} - {{$ep_movie->subtitle}}" data-h1="{{$ep_movie->title}} - tập {{$ep_movie->episode}}">{{$ep_movie->episode}}</span>
                              </li>
                           </a>
