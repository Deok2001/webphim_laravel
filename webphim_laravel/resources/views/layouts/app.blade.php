...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('/image/icon-admin.png') }}" type="image/x-icon" />
    <!-- Custom CSS -->
    ...
    <!--//webfonts-->
    <!-- chart -->
    <script src="{{ asset('backend/js/Chart.js') }}js/Chart.js"></script>
    <!-- //chart -->
    <!-- Metis Menu -->
  ...
  <body class="cbp-spmenu-push">
    @if (Auth::check())
        <div class="main-content">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="{{ route('country.index') }}">
                                    <i class="fa fa-angle-right"></i> Liệt kê quốc gia
                                </a>
                            </li>
                        </ul>
                        </li>
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="{{ route('info.create') }}">
                                    <i class="fa fa-angle-right"></i> Thêm thông tin 
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('info.index') }}">
                                    <i class="fa fa-angle-right"></i> Liệt kê thông tin
                                </a>
                            </li>
                        </ul>
                        </li>
            ...
            <div class="main-page">
                ...
                <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                    <i class="pull-left fa fa-pied-piper-alt user2 icon-rounded"></i>
                    <div class="stats">
                ...
                {{-- <div class="col-md-3 widget">
                    <div class="r3_counter_box">
                    <i class="pull-left fa fa-list-ol dollar2 icon-rounded"></i>
                    <div class="stats">
            ...
            <p>
                ...
                <a href="#" target="_blank">HoangAnhDuc</a>
            </p>
            </div>
            <!--//footer-->
        </div>
    ...
    {{-- <script>
        $('.show_video').click(function(){
            var movide_id = $(this).data('movie_video_id');
    ...
    <script type="text/javascript">
        $('.select-country').change(function(){
            ...
            $.ajax({
                ...
                success:function(data)
                    {
                       alert('Thay đổi quốc gia phim thành công!'); 
                        // toastr()->success('Thành Công','Cập nhật quốc gia phim!');
    ...
    {{-- select-subtitle --}}
    <script type="text/javascript">
        $('.select-subtitle').change(function(){
            var subtitle_val = $(this).val();
            var movie_id = $(this).attr('id');
            // alert(country_id);
            // alert(movie_id);
            $.ajax({
                url: "{{ route('select-subtitle') }}",
                method: "GET",
                data: {subtitle_val:subtitle_val, movie_id:movie_id},
                success:function(data)
                    {
                       alert('Thay đổi subtitle phim thành công!'); 
                    }
            });
        })
    </script>
    ...
    <script type="text/javascript">
        $('.select-status').change(function(){
            ...
            // alert(movie_id);
            $.ajax({
                url: "{{ route('select-status') }}",
                method: "GET",
                data: {status_val:status_val, movie_id:movie_id},
                success:function(data)
                    {
                       alert('Thay đổi status phim thành công!'); 
                    }
            });
        })
    </script>
    ...
    <script type="text/javascript">
        $('.select-hot').change(function(){
            var hot_val = $(this).val();
            var movie_id = $(this).attr('id');
            // alert(country_id);
            // alert(movie_id);
            $.ajax({
                url: "{{ route('select-hot') }}",
                method: "GET",
                data: {hot_val:hot_val, movie_id:movie_id},
                success:function(data)
                    {
                       alert('Thay đổi hot phim thành công!'); 
                    }
            });
        })
    </script>
    ...
    <script type="text/javascript">
        $('.select-format').change(function(){
            var format_val = $(this).val();
            var movie_id = $(this).attr('id');
            // alert(country_id);
            // alert(movie_id);
            $.ajax({
                url: "{{ route('select-format') }}",
                method: "GET",
                data: {format_val:format_val, movie_id:movie_id},
                success:function(data)
                    {
                       alert('Thay đổi format phim thành công!'); 
                    }
            });
        })
    </script>
    ...
    {{-- select-resolution --}}
    <script type="text/javascript">
        $('.select-resolution').change(function(){
            var resolution_val = $(this).val();
            var movie_id = $(this).attr('id');
            // alert(country_id);
            // alert(movie_id);
            $.ajax({
                url: "{{ route('select-resolution') }}",
                method: "GET",
                data: {resolution_val:resolution_val, movie_id:movie_id},
                success:function(data)
                    {
                       alert('Thay đổi resolution phim thành công!'); 
                    }
            });
        })
    </script>
    ...
    <script type="text/javascript">
        $('.select-topview').change(function(){
            ...
            $.ajax({
                ...
                method: "GET",
                data: {top_view: top_view, id_movie: id_movie},
                success:function()
                    {
    ...
    <script type="text/javascript">
        $('.select-season').change(function(){
            ...
            $.ajax({
                ...
                success:function()
                    {
                       alert('Thay đổi  phim theo  '+season+' thành công'); 
                    }
            });
        })
    </script>
    ...
    {{-- use sortable sắp xếp thứ tự danh mục --}}
    <script type="text/javascript">
    $('.order_position').sortable({
        ...
        update : function(event, ui) {
            ...
            $.ajax({
                ...
                success:function(data){
                    alert('Sắp xếp theo thứ tự thành công!');
                }
            })
        }
    })
