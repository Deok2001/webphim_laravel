...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon" href="{{ asset('/image/Provid-Films-corporate-video-production-minneapolis-mn-icon.webp') }}" type="image/x-icon" />
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
      <header id="header">
         <div class="container">
            <div class="row" id="headwrap">
               @foreach ($info_home as $key => $value)
                   
               
               <div class="col-md-3 col-sm-6 slogan">
                  <p class=""  style="width: 70%">
                     <a class="logo" href="" title="phim hay ">
                        <img style="object-fit: cover" src="{{ asset('uploads/logo/'.$value->logo) }}">   
                     </a>
                  </p>
      ...
      @foreach ($info_home as $key => $value_ft)
      <footer id="footer" class="clearfix">
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="" src=" {{ asset('uploads/logo/'.$value_ft->logo) }} " alt="" />
                  </div>
      ...
      <div class=" col-xs-12 col-sm-4 col-md-12">
            ...
            <p style="margin-left: 214px;line-height: 32px;color: aqua;">
               {{ $value_ft->copyright }}
            </p>
               ...
               $.getJSON('/json/movie.json', function(data){
                  $.each(data, function(key, value){
                     if(value.title.search(expression) != -1)
                     {
                        ...
                        $('#result').append('<li style="cursor:pointer; text-decoration: none; " class="list-group-item link-class"><img src="/uploads/movie/'+value.image+'" height = "40" width="40" class=""/>'+value.title+'<br> -> <span class="text-muted">'+value.description+'</span></li>');
                     }
                  });
               });
            }else{
